package pl.mankevich.designsystem.utils.placeholder
...
public object PlaceholderDefaults {
    ...
    public val shimmerAnimationSpec: InfiniteRepeatableSpec<Float> by lazy {
        infiniteRepeatable(
            animation = tween(durationMillis = 1000, delayMillis = 150),
...
public fun Modifier.placeholder(
    ...
    if (animationSpec != null && (visible || placeholderAlpha >= 0.01f)) {
        val infiniteTransition =
            infiniteTransition ?: rememberInfiniteTransition(label = "highlight transition")
